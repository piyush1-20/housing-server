...
--Create User
--------------------------
IF not exists (select Id from Users where UserEmail='Demo')
insert into Users(UserEmail,Password, PasswordKey,LastUpdatedOn,LastUpdatedBy)
select 'Demo',
...
Address2,CityId,FloorNo,TotalFloors,ReadyToMove,MainEntrance,Security,Gated,Maintenance,EstPossesionOn,Age,Description,PostedOn,PostedBy,LastUpdatedOn,LastUpdatedBy)
select 
1, --Sell Rent
